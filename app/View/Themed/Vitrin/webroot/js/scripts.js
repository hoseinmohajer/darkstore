...
var scrolltotop={
	...
	controlHTML: '<img src="/theme/Vitrin/images/totop-arrow.png" style="width:18px; height:18px; z-index:9999;" />',// '<img src="files/images/totop-arrow.png" style="width:30px; height:30px; z-index:9999;" />', //HTML for control, which is auto wrapped in DIV w/ ID="topcontrol"
	controlattrs: {offsetx:5, offsety:-2}, //offset of control relative to right/ bottom of window corner
